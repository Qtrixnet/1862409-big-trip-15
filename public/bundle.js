...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/flatpickr/dist/themes/material_blue.css":
/*!****************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/flatpickr/dist/themes/material_blue.css ***!
  \****************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_material_blue_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !../../../css-loader/dist/cjs.js!./material_blue.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/flatpickr/dist/themes/material_blue.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_material_blue_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ __webpack_exports__["default"] = (_css_loader_dist_cjs_js_material_blue_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
class Api {
  ...
  updatePoint(point) {
    return this._load({
      ...
      .then((points) =>
        points.map((wayPoint) =>
          _model_points__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient(
            wayPoint,
            _model_points__WEBPACK_IMPORTED_MODULE_0__["default"].makeCommonData(points),
          ),
        ),
      );
  }
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: eventTypes, eventCities, eventDescription, SortType, Mode, UserAction, UpdateType, FilterType, MenuItem, offers */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eventTypes", function() { return eventTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eventCities", function() { return eventCities; });
...
/* harmony import */ var _view_trip_cost__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/trip-cost */ "./src/view/trip-cost.js");
/* harmony import */ var _view_trip_info__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/trip-info */ "./src/view/trip-info.js");
/* harmony import */ var _view_new_event_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/new-event-button */ "./src/view/new-event-button.js");
/* harmony import */ var _presenter_trip__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/trip */ "./src/presenter/trip.js");
/* harmony import */ var _presenter_filter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./presenter/filter */ "./src/presenter/filter.js");
...
const newEventButtonComponent = new _view_new_event_button__WEBPACK_IMPORTED_MODULE_3__["default"]();
...
Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(navigationElement, siteMenuComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);

const tripMainElement = headerElement.querySelector('.trip-main');
Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(tripMainElement, newEventButtonComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
...
const filterPresenter = new _presenter_filter__WEBPACK_IMPORTED_MODULE_5__["default"](
  filtersElement,
  filterModel,
  pointsModel,
);
filterPresenter.init();
const tripPresenter = new _presenter_trip__WEBPACK_IMPORTED_MODULE_4__["default"](
  tripEventsElement,
  pointsModel,
  filterModel,
);
...
const handleSiteMenuClick = (menuItem) => {
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].ADD_NEW_EVENT:
      ...
      filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].MAJOR, _const_js__WEBPACK_IMPORTED_MODULE_9__["FilterType"].EVERYTHING);
      tripPresenter.init();
...
Promise.all([api.getPoints(), api.getDestinations(), api.getOffers()])
  .then((points) => {
    const tripData = {
      allWayPoints: points[0],
      allCities: points[1],
      allOffers: points[2],
    };
    const adaptedData = _model_points__WEBPACK_IMPORTED_MODULE_6__["default"].adaptToClient(tripData);

    pointsModel.setPoints(_const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT, adaptedData);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(
      tripMainElement,
      new _view_trip_info__WEBPACK_IMPORTED_MODULE_2__["default"](adaptedData).getElement(),
      _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN,
    );
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(
      tripInfoElement,
      new _view_trip_cost__WEBPACK_IMPORTED_MODULE_1__["default"](adaptedData).getElement(),
      _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND,
    );

    siteMenuComponent.setMenuClickHandler(handleSiteMenuClick);
  })
  .catch((error) => {
    pointsModel.setPoints(_const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT, []);
    siteMenuComponent.setMenuClickHandler(handleSiteMenuClick);
    console.log(error);
  })
...
/* harmony import */ var _utils_abstract_observer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/abstract-observer.js */ "./src/utils/abstract-observer.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");



class Filter extends _utils_abstract_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/* harmony import */ var _utils_abstract_observer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/abstract-observer */ "./src/utils/abstract-observer.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_1__);



class Points extends _utils_abstract_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._points = [];
  }
  ...
  static adaptToClient(allData) {
    return allData.allWayPoints.map((data) => ({
      citiesList: allData.allCities,
      city: data.destination,
      eventCities: allData.allCities,
      fullTimeFrom: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(new Date(data.date_from)),
      fullTimeTo: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(new Date(data.date_to)),
      id: data.id,
      isFavorite: data.is_favorite,
      minifiedTimeFrom: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(new Date(data.date_from)).format('HH:mm'),
      minifiedTimeTo: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(new Date(data.date_to)).format('HH:mm'),
      offers: data.offers,
      allOffers: allData.allOffers,
      price: data.base_price,
      duration: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(new Date(data.date_to)) - dayjs__WEBPACK_IMPORTED_MODULE_1___default()(new Date(data.date_from)),
      type: data.type,
      wayPointsList: allData.allOffers,
    }));
  }
  ...
  static adaptToServer(point) {
    const adaptedPoint = Object.assign({}, point, {
      // due_date:
      //   point.dueDate instanceof Date ? point.dueDate.toISOString() : null, // На сервере дата хранится в ISO формате
...
class Filter {
  ...
  init() {
    ...
    this._filterComponent = new _view_filters__WEBPACK_IMPORTED_MODULE_0__["default"](
      filters,
    ...
    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(
        this._filterContainer,
        this._filterComponent,
        _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND,
      );
      return;
    }
...
/* harmony import */ var _view_event_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/event-form */ "./src/view/event-form.js");
...
class PointNew {
  ...
  init(callback) {
    ...
    this._pointEditComponent = new _view_event_form__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._pointEditComponent.setFormSubmitHandler(this._handleFormSubmit);
    this._pointEditComponent.setDeleteClickHandler(this._handleDeleteClick);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._pointListContainer, this._pointEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
  ...
  destroy() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._pointEditComponent);
    this._pointEditComponent = null;
  ...
  _handleFormSubmit(point) {
    this._changeData(
      _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].ADD_POINT,
...
/* harmony import */ var _view_trip_events_item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/trip-events-item */ "./src/view/trip-events-item.js");
/* harmony import */ var _view_event_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/event-form */ "./src/view/event-form.js");
...
class Point {
  constructor(pointsListContainer, changeData, changeMode) {
    ...
    this._mode = _const__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT;
  ...
  init(wayPoint) {
    ...
    this._eventItemComponent = new _view_trip_events_item__WEBPACK_IMPORTED_MODULE_0__["default"](wayPoint);
    this._eventEditFormComponent = new _view_event_form__WEBPACK_IMPORTED_MODULE_1__["default"](wayPoint);
    ...
    if(prevEventItemComponent === null || this._eventEditFormComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._wayPointsListContainer, this._eventItemComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
      return;
    }

    if (this._mode === _const__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventItemComponent, prevEventItemComponent);
    }

    if (this._mode === _const__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDITING) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventEditFormComponent, prevEventEditFormComponent);
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevEventItemComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevEventEditFormComponent);
  }

  destroy(){
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._eventItemComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._eventEditFormComponent);
  }
  ...
  _replaceItemToForm() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventEditFormComponent, this._eventItemComponent);
    document.addEventListener('keydown', this._escKeyDownHandler);
    this._changeMode();
    this._mode = _const__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDITING;
  }

  _replaceFormToItem() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventItemComponent, this._eventEditFormComponent);
    document.removeEventListener('keydown', this._escKeyDownHandler);
    this._mode = _const__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT;
  }
  ...
  _handleFormSubmit(update) {
    ...
    this._changeData(
      _const__WEBPACK_IMPORTED_MODULE_3__["UserAction"].UPDATE_POINT,
      _const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MAJOR,
      update,
    );
    this._replaceFormToItem();
  }
...
/* harmony import */ var _view_trip_events_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/trip-events-list */ "./src/view/trip-events-list.js");
/* harmony import */ var _view_no_event__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/no-event */ "./src/view/no-event.js");
/* harmony import */ var _view_loading__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/loading */ "./src/view/loading.js");
/* harmony import */ var _point__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./point */ "./src/presenter/point.js");
/* harmony import */ var _point_new_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./point-new.js */ "./src/presenter/point-new.js");
...
/* harmony import */ var _utils_tripPoint__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/tripPoint */ "./src/utils/tripPoint.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
class Trip {
  constructor(tripEventsElementContainer, pointsModel, filterModel) {
    ...
    this._noEventComponent = new _view_no_event__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._loadingComponent = new _view_loading__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._tripEventsListComponent = new _view_trip_events_list__WEBPACK_IMPORTED_MODULE_1__["default"]();

    this._pointPresenter = new Map();

    this._filterType = _const_js__WEBPACK_IMPORTED_MODULE_9__["FilterType"].EVERYTHING;
    ...
    this._pointNewPresenter = new _point_new_js__WEBPACK_IMPORTED_MODULE_5__["default"](
  ...
  init() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(
      this._tripEventsElementContainer,
      this._tripEventsListComponent,
      _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND,
    );
    this._pointsModel.addObserver(this._handleModelEvent);
    this._filterModel.addObserver(this._handleModelEvent);
    this._renderTrip();
  ...
  destroy() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._tripEventsListComponent);
  ...
  _getPoints() {
    ...
    const filtredPoints = _utils_filter__WEBPACK_IMPORTED_MODULE_6__["filter"][this._filterType](points);

    switch (this._currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["SortType"].TIME:
        return filtredPoints.sort(_utils_tripPoint__WEBPACK_IMPORTED_MODULE_8__["sortPointsByTime"]);
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["SortType"].PRICE:
        return filtredPoints.sort(_utils_tripPoint__WEBPACK_IMPORTED_MODULE_8__["sortPointsByPrice"]);
      default:
        return filtredPoints.sort(_utils_tripPoint__WEBPACK_IMPORTED_MODULE_8__["sortPointsByDay"]);
    }
  }
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["UserAction"].ADD_POINT:
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["UserAction"].DELETE_POINT:
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].PATCH:
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].MINOR:
        ...
        this._renderTrip();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].MAJOR:
        this._clearTrip({ resetSortType: true });
        this._renderTrip();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT:
  ...
  _renderSort() {
    ...
    this._sortComponent = new _view_sort__WEBPACK_IMPORTED_MODULE_0__["default"](this._currentSortType);
    this._sortComponent.setSortTypeChangeHandler(this._handleSortTypeChange);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(
      this._tripEventsElementContainer,
      this._sortComponent,
      _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].AFTERBEGIN,
    );
  }

  _renderWayPoint(wayPoint) {
    const pointPresenter = new _point__WEBPACK_IMPORTED_MODULE_4__["default"](
      this._tripEventsListComponent,
      this._handleViewAction,
  ...
  _renderNoEvent() {
    ...
    this._noEventComponent = new _view_no_event__WEBPACK_IMPORTED_MODULE_2__["default"](this._filterType);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(
      this._tripEventsElementContainer,
  ...
  _clearTrip({ resetSortType = false } = {}) {
    ...
    if (this._noEventComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._noEventComponent);
    }
...
/***/ "./src/utils/abstract-observer.js":
/*!****************************************!*\
  !*** ./src/utils/abstract-observer.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AbstractObserver; });
...
/* harmony import */ var _tripPoint__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tripPoint */ "./src/utils/tripPoint.js");



const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING]: (points) => points.filter((point) => point),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FUTURE]: (points) => points.filter((point) => Object(_tripPoint__WEBPACK_IMPORTED_MODULE_1__["isDateFuture"])(point.tripDate)),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].PAST]: (points) => points.filter((point) => Object(_tripPoint__WEBPACK_IMPORTED_MODULE_1__["isDatePast"])(point.tripDate)),
};
...
/***/ "./src/utils/tripPoint.js":
/*!********************************!*\
  !*** ./src/utils/tripPoint.js ***!
  \********************************/
/*! exports provided: getOffersMarkup, getWayPointsListMarkup, getDestinationListMarkup, sortPointsByDay, sortPointsByTime, sortPointsByPrice, isDateFuture, isDatePast */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOffersMarkup", function() { return getOffersMarkup; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWayPointsListMarkup", function() { return getWayPointsListMarkup; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDestinationListMarkup", function() { return getDestinationListMarkup; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isDateFuture", function() { return isDateFuture; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isDatePast", function() { return isDatePast; });
...
const getWayPointsListMarkup = (wayPointsList) => {
...
const getDestinationListMarkup = (citiesList) => {
...
const sortPointsByDay = (taskA, taskB) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskA.tripDate).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskB.tripDate));

const sortPointsByTime = (taskA, taskB) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskB.duration).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskA.duration));

const sortPointsByPrice = (taskA, taskB) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskB.price).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskA.price));

const isDateFuture = (date) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(date);

const isDatePast = (date) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(date);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventEditForm; });
...
/* harmony import */ var _node_modules_flatpickr_dist_themes_material_blue_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../node_modules/flatpickr/dist/themes/material_blue.css */ "./node_modules/flatpickr/dist/themes/material_blue.css");
...
const BLANK_POINT = {
  ...
  duration: 0,
  eventCities: [],
  fullTimeFrom: dayjs__WEBPACK_IMPORTED_MODULE_2___default()(),
  fullTimeTo: dayjs__WEBPACK_IMPORTED_MODULE_2___default()(),
  id: '',
  isFavorite: false,
  minifiedTimeFrom: dayjs__WEBPACK_IMPORTED_MODULE_2___default()().format('hh:mm'),
  minifiedTimeTo: dayjs__WEBPACK_IMPORTED_MODULE_2___default()().format('hh:mm'),
  offers: [{
    type: 'flight',
    offers: [
      {
  ...
  price: '',
  tripDate: dayjs__WEBPACK_IMPORTED_MODULE_2___default()(),
  type: 'flight',
  wayPointsList: [
    'taxi',
    'bus',
...
const createOffersTemplate = (offers, matchedOffers, isOffers) => {
  // console.log(offers, matchedOffers);
    ...
    <form class="event event--edit" action="#" method="post">
      <header class="event__header">
        ...
        <div class="event__field-group event__field-group--destination">
          ...
          <input class="event__input event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(city.name)}" list="destination-list-1">
        ...
        <div class="event__field-group event__field-group--price">
          ...
          <input class="event__input event__input--price" id="event-price-1" type="text" pattern="^[ 0-9]+$" name="event-price" value="${he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(`${price}`)}">
        </div>
...
class EventEditForm extends _smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _setDatepicker() {
    ...
    this._datepicker = Object(flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])(
...
class AddNewEvent extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
const noEventsTextType = {
  [_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING]: 'Click New Event to create your first point',
  [_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FUTURE]: 'There are no future events now',
  [_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].PAST]: 'There are no past events now',
};
...
class NoEvent extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    super();
    this._data = data;
  }
...
const createSortTemplate = () =>
  `<form class="trip-events__trip-sort trip-sort" action="#" method="get">
    <div class="trip-sort__item trip-sort__item--day">
      ...
      <label class="trip-sort__btn" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}" for="sort-day">Day</label>
    </div>
    ...
    <div class="trip-sort__item trip-sort__item--time">
      ...
      <label class="trip-sort__btn" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}" for="sort-time">Time</label>
    </div>
    <div class="trip-sort__item trip-sort__item--price">
      <input id="sort-price" class="trip-sort__input visually-hidden" type="radio" name="trip-sort" value="sort-price">
      <label class="trip-sort__btn" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}" for="sort-price">Price</label>
    </div>
...
const createEventsItemTemplate = ({
  ...
  return `<li class="trip-events__item">
    <div class="event">
      ...
      <h3 class="event__title">${type} ${he__WEBPACK_IMPORTED_MODULE_1___default.a.encode(city.name)}</h3>
      ...
      <p class="event__price">
        &euro;&nbsp;<span class="event__price-value">${he__WEBPACK_IMPORTED_MODULE_1___default.a.encode(`${price}`)}</span>
      </p>
...
class TripEventsItem extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class TripEventsList extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createTripInfoTemplate = (points) => {
  if (points) {
    const cities = points[0].citiesList;
    ...
    const handleCities = (citiesList) => {
      if (citiesList) {
        const onlyCities = citiesList.map((city) => city.name);
        //* Форматируем список городов, если их больше 2х
        return `${onlyCities[0]} ${onlyCities.length > 2 ? '- ... -' : '-'} ${
          onlyCities[onlyCities.length - 1]
        }`;
      }
    };
...
class TripInfo extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
